...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lotes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_de_lote') ? 'is-invalid' : '' }}" name="tipo_de_lote" id="tipo_de_lote">
                    ...
                    @foreach(App\Models\Lote::TIPO_DE_LOTE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_de_lote', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comprimento') ? 'is-invalid' : '' }}" type="text" name="comprimento" id="comprimento" value="{{ old('comprimento', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('altura') ? 'is-invalid' : '' }}" type="text" name="altura" id="altura" value="{{ old('altura', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lote_vazio') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lote_vazio" id="lote_vazio" value="Sim" {{ old('lote_vazio', 'Não') == 'Sim' ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('reservado') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="reservado" id="reservado" value="Sim" {{ old('reservado', 'Não') == 'Sim' ? 'checked' : '' }}>
