...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.obitos-lotes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.obito.fields.data_de_nascimento_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.obito.fields.data_de_falecimento_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.obito.fields.data_de_sepultamento_helper') }}</span>
            </div>
            <div class="form-group">
