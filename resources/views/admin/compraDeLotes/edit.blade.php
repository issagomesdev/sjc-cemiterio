...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.compra-de-lotes.update", [$compraDeLote->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="numero_dam">{{ trans('cruds.compraDeLote.fields.numero_dam') }}</label>
                <input class="form-control {{ $errors->has('numero_dam') ? 'is-invalid' : '' }}" type="text" name="numero_dam" id="numero_dam" value="{{ old('numero_dam', $compraDeLote->numero_dam) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ano_dam') ? 'is-invalid' : '' }}" type="text" name="ano_dam" id="ano_dam" value="{{ old('ano_dam', $compraDeLote->ano_dam) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_da_aquisicao') ? 'is-invalid' : '' }}" type="text" name="data_da_aquisicao" id="data_da_aquisicao" value="{{ old('data_da_aquisicao', $compraDeLote->data_da_aquisicao) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('observacoes') ? 'is-invalid' : '' }}" name="observacoes" id="observacoes">{{ old('observacoes', $compraDeLote->observacoes) }}</textarea>
