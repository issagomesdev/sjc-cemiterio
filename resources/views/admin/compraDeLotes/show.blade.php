...
<div class="card">
    <div class="card-header">
        Visualizar Compra de Lote
    </div>

    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.compra-de-lotes.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.compraDeLote.fields.id') }}
                        </th>
                        <td>
                            {{ $compraDeLote->id }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.compraDeLote.fields.observacoes') }}
                        </th>
                        <td>
                            {{ $compraDeLote->observacoes }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.compraDeLote.fields.updated_at') }}
                        </th>
                        <td>
                            {{ $compraDeLote->updated_at }}
                        </td>
                    </tr>
                </tbody>
            </table>
