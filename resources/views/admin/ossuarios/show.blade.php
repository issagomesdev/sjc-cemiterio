...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.ossuarios.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    <tr>
                        <th>
                            {{ trans('cruds.ossuario.fields.id') }}
                        </th>
                        <td>
                            {{ $ossuario->id }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.ossuario.fields.descricao') }}
                        </th>
                        <td>
                            {{ $ossuario->descricao }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.ossuario.fields.updated_at') }}
                        </th>
                        <td>
                            {{ $ossuario->updated_at }}
                        </td>
