...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.setores.index') }}">
            ...
            <table id="example" class="table table-striped table-hover table-bordered">
              <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.setore.fields.descricao') }}
                        </th>
                        <td>
                            {{ $setore->descricao }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.setore.fields.updated_at') }}
                        </th>
                        <td>
                            {{ $setore->updated_at }}
                        </td>
