...
<div class="card">
    <div class="card-header">
        Atualizar Óbito em Gaveta
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.obitos-gavetas.update", [$obitosGaveta->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('responsavel') ? 'is-invalid' : '' }}" name="responsavel_id" id="responsavel_id">
                    @foreach($responsaveis as $id => $entry)
                        <option value="{{ $id }}" {{ (old('responsavel_id') ? old('responsavel_id') : $obitosGaveta->responsavel->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cemiterio') ? 'is-invalid' : '' }}" name="cemiterio_id" id="cemiterio_id">
                    @foreach($cemiterios as $id => $entry)
                        <option value="{{ $id }}" {{ (old('cemiterio_id') ? old('cemiterio_id') : $obitosGaveta->cemiterio->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ossuario') ? 'is-invalid' : '' }}" name="ossuario_id" id="ossuario_id">
                    @foreach($ossuarios as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ossuario_id') ? old('ossuario_id') : $obitosGaveta->ossuario->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('gaveta') ? 'is-invalid' : '' }}" name="gaveta_id" id="gaveta_id">
                    @foreach($gavetas as $id => $entry)
                        <option value="{{ $id }}" {{ (old('gaveta_id') ? old('gaveta_id') : $obitosGaveta->gaveta->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
...
-->
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_dam') ? 'is-invalid' : '' }}" type="text" name="numero_dam" id="numero_dam" value="{{ old('numero_dam', $obitosGaveta->numero_dam) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ano_dam') ? 'is-invalid' : '' }}" type="text" name="ano_dam" id="ano_dam" value="{{ old('ano_dam', $obitosGaveta->ano_dam) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_do_falecido') ? 'is-invalid' : '' }}" type="text" name="nome_do_falecido" id="nome_do_falecido" value="{{ old('nome_do_falecido', $obitosGaveta->nome_do_falecido) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_de_nascimento') ? 'is-invalid' : '' }}" type="text" name="data_de_nascimento" id="data_de_nascimento" value="{{ old('data_de_nascimento', $obitosGaveta->data_de_nascimento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_de_falecimento') ? 'is-invalid' : '' }}" type="text" name="data_de_falecimento" id="data_de_falecimento" value="{{ old('data_de_falecimento', $obitosGaveta->data_de_falecimento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_de_sepultamento') ? 'is-invalid' : '' }}" type="text" name="data_de_sepultamento" id="data_de_sepultamento" value="{{ old('data_de_sepultamento', $obitosGaveta->data_de_sepultamento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_da_mae') ? 'is-invalid' : '' }}" type="text" name="nome_da_mae" id="nome_da_mae" value="{{ old('nome_da_mae', $obitosGaveta->nome_da_mae) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome_do_pai') ? 'is-invalid' : '' }}" type="text" name="nome_do_pai" id="nome_do_pai" value="{{ old('nome_do_pai', $obitosGaveta->nome_do_pai) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sexo') ? 'is-invalid' : '' }}" name="sexo" id="sexo">
                    ...
                    @foreach(App\Models\ObitosGaveta::SEXO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sexo', $obitosGaveta->sexo) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('sexo'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('cor_raca') ? 'is-invalid' : '' }}" name="cor_raca" id="cor_raca">
                    ...
                    @foreach(App\Models\ObitosGaveta::COR_RACA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('cor_raca', $obitosGaveta->cor_raca) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('certidao_de_obito') ? 'is-invalid' : '' }}" type="text" name="certidao_de_obito" id="certidao_de_obito" value="{{ old('certidao_de_obito', $obitosGaveta->certidao_de_obito) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('causa_da_morte') ? 'is-invalid' : '' }}" type="text" name="causa_da_morte" id="causa_da_morte" value="{{ old('causa_da_morte', $obitosGaveta->causa_da_morte) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('naturalidade') ? 'is-invalid' : '' }}" type="text" name="naturalidade" id="naturalidade" value="{{ old('naturalidade', $obitosGaveta->naturalidade) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\ObitosGaveta::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $obitosGaveta->estado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $obitosGaveta->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $obitosGaveta->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rua') ? 'is-invalid' : '' }}" type="text" name="rua" id="rua" value="{{ old('rua', $obitosGaveta->rua) }}">
                @if($errors->has('rua'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rua') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ old('numero', $obitosGaveta->numero) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('observacoes') ? 'is-invalid' : '' }}" name="observacoes" id="observacoes">{{ old('observacoes', $obitosGaveta->observacoes) }}</textarea>
