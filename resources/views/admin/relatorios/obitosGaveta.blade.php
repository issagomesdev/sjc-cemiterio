...
<div class="card">
    <div class="card-header">
        Relatórios de Óbitos em Gavetas
    </div>
            ...
            <table class="table table-bordered table-striped table-hover datatable datatable-relatorios">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.obitosGaveta.fields.situacao') }}
                        </th>
                        <th>
                            {{ trans('cruds.obitosGaveta.fields.assinatura') }}
                        </th>
                        <th>
                ...
                <tbody>
                  @foreach($obitosGavetas as $key => $obito)
                      <tr data-entry-id="{{ $obito->id }}">
                          ...
                          <td>
                              {{ $obito->ossuario->indentificacao ?? '' }}
                          </td>
                          <td>
                              {{ $obito->gaveta->indentificacao ?? '' }}
                          </td>
                          <td>
                              {{ $obito->numero_dam ?? '' }}
                          </td>
