...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.responsaveis.update", [$responsaveis->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="nome">{{ trans('cruds.responsavel.fields.nome') }}</label>
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $responsaveis->nome) }}">
                @if($errors->has('nome'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('parentesco') ? 'is-invalid' : '' }}" name="parentesco" id="parentesco">
                    ...
                    @foreach(App\Models\Responsavel::PARENTESCO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('parentesco', $responsaveis->parentesco) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sexo') ? 'is-invalid' : '' }}" name="sexo" id="sexo">
                    ...
                    @foreach(App\Models\Responsavel::SEXO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sexo', $responsaveis->sexo) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('sexo'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cpf_cnpj') ? 'is-invalid' : '' }}" type="text" name="cpf_cnpj" id="cpf_cnpj" value="{{ old('cpf_cnpj', $responsaveis->cpf_cnpj) }}">
                @if($errors->has('cnpj'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cnpj') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado" id="estado">
                    ...
                    @foreach(App\Models\Responsavel::ESTADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('estado', $responsaveis->estado) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $responsaveis->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $responsaveis->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rua') ? 'is-invalid' : '' }}" type="text" name="rua" id="rua" value="{{ old('rua', $responsaveis->rua) }}">
                @if($errors->has('rua'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rua') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ old('numero', $responsaveis->numero) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('complemento') ? 'is-invalid' : '' }}" type="text" name="complemento" id="complemento" value="{{ old('complemento', $responsaveis->complemento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $responsaveis->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_de_contato') ? 'is-invalid' : '' }}" type="text" name="numero_de_contato" id="numero_de_contato" value="{{ old('numero_de_contato', $responsaveis->numero_de_contato) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero_de_contato_2') ? 'is-invalid' : '' }}" type="text" name="numero_de_contato_2" id="numero_de_contato_2" value="{{ old('numero_de_contato_2', $responsaveis->numero_de_contato_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('observacoes') ? 'is-invalid' : '' }}" type="text" name="observacoes" id="observacoes" value="{{ old('observacoes', $responsaveis->observacoes) }}">
